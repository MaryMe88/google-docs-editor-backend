...
Tag constants и helpers: загрузка CANONICAL_TAGS из config/tag_map.json,
KNOWN_TAGS, нормализация тегов, get_*_tags_for_category.
...
def _load_canonical_tags() -> dict[str, dict[str, Any]]:
    ...
    """
    tag_map_path = Path(__file__).parent.parent.parent / "config" / "tag_map.json"
