...
def test_select_few_shot_deterministic() -> None:
    ...
    entries = [{"id": str(i), "wrong": f"w{i}", "correct": f"c{i}"} for i in range(15)]
...
def test_select_few_shot_respects_max_examples() -> None:
    ...
    entries = [{"wrong": f"w{i}", "correct": f"c{i}"} for i in range(20)]
...
def test_select_few_shot_respects_pool_size() -> None:
    ...
    entries = [{"id": str(i), "wrong": f"w{i}", "correct": f"c{i}"} for i in range(50)]
...
def test_select_few_shot_returns_less_when_pool_small() -> None:
    ...
    entries = [{"id": str(i), "wrong": f"w{i}", "correct": f"c{i}"} for i in range(4)]
